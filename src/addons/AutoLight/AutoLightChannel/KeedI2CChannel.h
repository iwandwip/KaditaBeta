...
#ifndef KEED_I2C_CHANNEL_H
#define KEED_I2C_CHANNEL_H
...
class KeedI2CChannel : public KeedBase {
private:
    IOExpander **ioBase;
    uint8_t sequence;
    uint32_t ioTimer;
    ...
    void (KeedI2CChannel::*taskTemp)();
    void (KeedI2CChannel::*sequences[(TASK_SEQUENCE_NUM + 2)])();
...
public:
    ...
    void (KeedI2CChannel::*getSequence(uint8_t index))();
