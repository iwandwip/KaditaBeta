...
#ifndef KEED_EXT_CHANNEL_H
#define KEED_EXT_CHANNEL_H
...
class KeedExtChannel : public KeedBase {
private:
    IOExpander **ioBase;
    uint8_t sequence;
    uint32_t ioTimer;
    ...
    void (KeedExtChannel::*taskTemp)();
    void (KeedExtChannel::*sequences[(TASK_SEQUENCE_NUM + 2)])();
...
public:
    ...
    void (KeedExtChannel::*getSequence(uint8_t index))();
